...
char* map_rrd_file(char *input_file);
...
////////////////////////////////////////////////////////////////////
    ...
    char* changed_file = map_rrd_file(local_file);
    /*strcat(dir,"/");
    strcat(dir,changed_file);*/
    char* dir_sep = "/";  
    char* new_dir;
    new_dir = (char *)malloc(strlen(dir) + strlen(changed_file) +  strlen(dir_sep) + 1);
    strcpy(new_dir,dir);
    strcat(new_dir,dir_sep);
    strcat(new_dir,changed_file);

     printf("new dir:::::%s", new_dir);

    printf("RRD_CREATE.C: Writing to: %s\n",new_dir);

    argv[optind] = (char **)new_dir;
////////////////////////////////////////////////////////////////////
    rc = rrd_create_r(argv[optind],
                      pdp_step, last_up,
                      argc - optind - 1, (const char **) (argv + optind + 1));
    /*rc = rrd_create_r(new_dir,
                      pdp_step, last_up,
                      argc - optind - 1, (const char **) (argv + optind + 1));*/
    printf("Finished Creating Stuff!!!\n");
    return rc;
}
